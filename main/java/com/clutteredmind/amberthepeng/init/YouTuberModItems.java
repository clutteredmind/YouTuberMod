...
public class YouTuberModItems
{
	...
	{
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(youTubeLogoFragment, 0, new ModelResourceLocation(Reference.MOD_ID + ":" + youTubeLogoFragment.getUnlocalizedName().substring(5), "inventory"));
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(rawTurtleMeat, 0, new ModelResourceLocation(Reference.MOD_ID + ":" + rawTurtleMeat.getUnlocalizedName().substring(5), "inventory"));
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(cookedTurtleMeat, 0, new ModelResourceLocation(Reference.MOD_ID + ":" + cookedTurtleMeat.getUnlocalizedName().substring(5), "inventory"));
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(turtleStew, 0, new ModelResourceLocation(Reference.MOD_ID + ":" + turtleStew.getUnlocalizedName().substring(5), "inventory"));
	}
}
